...
function SubjectCard({ heading, subjects }) {
  ...
  return (
    <div
      className="lg:w-[30%] md:w-[35%] w-[70%] h-64 m-6 bg-white shadow-lg p-2 md:p-4 rounded-lg border border-gray-200 transform hover:scale-105"
      ...
      >
        {subjects.map((subject, index) => (
          <NavLink
            key={index}
            to="#"
            className="py-1 px-3 lg:mr-3 md:py-2 md:px-4 mt-4 border-2 border-[#009c86] text-black font-bold rounded-md md:text-lg text-md transition-opacity duration-500 ease-in-out"
            style={{
