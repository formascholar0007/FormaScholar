...
const Home = () => {
  ...
  return (
    <div className="lg:h-full max-h-full bg-gradient-to-b from-gray-900 to-gray-900 text-white font-Alice overflow-hidden">
      <div className="container mx-auto px-8 py-8 overflow-hidden">
