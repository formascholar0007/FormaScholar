...
function ForgetPassword() {
  ...
  return (
    <section className="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow-lg shadow-slate-300 font-Alice">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className={`$${errorMessage ? " " : "opacity-0"}`}>
          ...
          {/* Success box */}
          {resetSuccess && (
            <div className="bg-teal-100 border-l-4 border-teal-500 text-teal-900 shadow-lg p-4">
